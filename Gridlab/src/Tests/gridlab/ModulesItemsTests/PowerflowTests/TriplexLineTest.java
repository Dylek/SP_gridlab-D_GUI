...
import gridlab.ModulesItems.Powerflow.TriplexLine;
 ...
 */
public class TriplexLineTest extends TestCase {

    private TriplexLine objectTest = new TriplexLine();
...
//
//        assertEquals("object triplexline{ \n"+"phases    ABC;
//                "+;
//                "length    0;
//                "+;
//
